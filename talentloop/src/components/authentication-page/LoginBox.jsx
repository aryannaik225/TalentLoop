    ...
    <div className="w-full h-full flex justify-center items-center p-4 sm:p-6 md:p-8">
      <div className="flex flex-col items-center w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl">
        ...
        <div className="mt-2 sm:mt-4 flex flex-col items-center">
          <span className="poppins-semibold text-xl sm:text-2xl md:text-3xl">For Recruiters</span>
        ...
        <div className="flex flex-col items-center mt-4">
          <span className="text-xs sm:text-sm poppins-regular">{isSignUp ? "Already a member of TalentLoop?" : "New to TalentLoop? Post your first job today!"}</span>
          <button className="text-xs sm:text-sm poppins-medium text-black" onClick={() => setIsSignUp(!isSignUp)}>
